...
class ModelKerasResnetAugmentation(ModelBase):
    ...
    def train(self, prms, x_tr, y_tr, x_te, y_te, w_tr=None, w_te=None):
        ...
        g_tr = Iterator(x_tr, y_tr, batch_size=batch_size, shuffle=True, seed=71, w=w_tr, batch_x_func=augmentor.transform_batch_train_image)
        ...
        logger.info(self.hist.history["val_loss"][-1])
